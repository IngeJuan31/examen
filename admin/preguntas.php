...
echo '
<div id="spinnerCargaPreguntas" role="status" aria-live="polite" aria-label="Cargando participantes"
    ...
    <div style="text-align:center;">
        ...
        <div style="margin-top:1.2rem; color:#1565C0; font-weight:600; font-size:1.125rem;
            ...
            <i class="fas fa-question" aria-hidden="true"></i> Cargando Preguntas...
        </div>
    </div>
</div>
';
...
window.addEventListener("load", function() {
    var spinner = document.getElementById("spinnerCargaPreguntas");
    if (spinner) {
